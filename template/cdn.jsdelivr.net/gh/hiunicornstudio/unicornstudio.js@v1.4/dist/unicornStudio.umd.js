(function(I, O) {
    typeof exports == "object" && typeof module < "u" ? O(exports) : typeof define == "function" && define.amd ? define(["exports"], O) : (I = typeof globalThis < "u" ? globalThis : I || self, O(I.UnicornStudio = {}))
})(this, function(I) {
    "use strict";
    var is = Object.defineProperty;
    var rs = (I, O, g) => O in I ? is(I, O, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: g
    }) : I[O] = g;
    var D = (I, O, g) => rs(I, typeof O != "symbol" ? O + "" : O, g);
    let O = 0;

    function g() {
        if (!(O > 100)) {
            if (O === 100) console.warn("Curtains: too many warnings thrown, stop logging.");
            else {
    ...
    let et = class {
        constructor(e) {
            if (this.type = "Scene", !e || e.type !== "Renderer") C(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                C(this.type + ": Renderer WebGL context is undefined", e);
                return
            }
    ...
    class it {
        constructor({
            ...
            if (this.gl = this.canvas.getContext("webgl2", w), this._isWebGL2 = !!this.gl, this.gl || (this.gl = this.canvas.getContext("webgl", w) || this.canvas.getContext("experimental-webgl", w)), this.gl) this.onSuccess && this.onSuccess();
            else {
    ...
    class nt {
        constructor(e, t, s) {
            if (this.type = "Uniforms", !e || e.type !== "Renderer") C(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                C(this.type + ": Renderer WebGL context is undefined", e);
                return
            }
...
`).replace(/\n/g, "");
    ...
    class Ve {
        constructor(e, {
            ...
            if (this.type = "Program", !e || e.type !== "Renderer") C(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                C(this.type + ": Renderer WebGL context is undefined", e);
                return
            }
            this.renderer = e, this.gl = this.renderer.gl, this.parent = t, this.defaultVsCode = this.parent.type === "Plane" ? ht : lt, this.defaultFsCode = this.parent.type === "Plane" ? ot : dt, s ? this.vsCode = s : (!this.renderer.production && this.parent.type === "Plane" && g(this.parent.type + ": No vertex shader provided, will use a default one"), this.vsCode = this.defaultVsCode), i ? this.fsCode = i : (this.renderer.production || g(this.parent.type + ": No fragment shader provided, will use a default one"), this.fsCode = this.defaultFsCode), this.compiled = !0, this.setupProgram()
        }
        createShader(e, t) {
...
`, this.gl.getShaderInfoLog(s)), C(a), g(this.type + ": Will use a default", i), this.createShader(t === this.gl.VERTEX_SHADER ? this.defaultVsCode : this.defaultFsCode, t)
            }
            return s
        }
        useNewShaders() {
    ...
    class ct {
        constructor(e, {
            ...
            if (this.type = "Geometry", !e || e.type !== "Renderer") C(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                C(this.type + ": Renderer WebGL context is undefined", e);
                return
            }
    ...
    class J {
        ...
        getInverse() {
            ...
            let i = e[0],
                ...
                b = f * E - m * T,
                R = p * E - m * w,
                _ = M * R - A * b + F * y + x * Q - V * W + $ * B;
            return _ ? (_ = 1 / _, s[0] = (l * R - d * b + c * y) * _, s[1] = (a * b - r * R - h * y) * _, s[2] = (T * $ - w * V + E * x) * _, s[3] = (p * V - f * $ - m * x) * _, s[4] = (d * Q - o * R - c * W) * _, s[5] = (i * R - a * Q + h * W) * _, s[6] = (w * F - v * $ - E * A) * _, s[7] = (u * $ - p * F + m * A) * _, s[8] = (o * b - l * Q + c * B) * _, s[9] = (r * Q - i * b - h * B) * _, s[10] = (v * V - T * F + E * M) * _, s[11] = (f * F - u * V - m * M) * _, s[12] = (l * W - o * y - d * B) * _, s[13] = (i * y - r * W + a * B) * _, s[14] = (T * A - v * x - w * M) * _, s[15] = (u * x - f * A + p * M) * _, t) : null
        }
        scale(e) {
            let t = this.elements;
        ...
        compose(e, t, s) {
            ...
            const r = t.elements[0],
                ...
                F = s.y,
                x = s.z;
            return i[0] = (1 - (m + T)) * A, i[1] = (f + M) * A, i[2] = (p - E) * A, i[3] = 0, i[4] = (f - M) * F, i[5] = (1 - (u + T)) * F, i[6] = (v + w) * F, i[7] = 0, i[8] = (p + E) * x, i[9] = (v - w) * x, i[10] = (1 - (u + m)) * x, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this
        }
        composeFromOrigin(e, t, s, i) {
            ...
            const a = t.elements[0],
                ...
                re = (T - E) * V,
                N = (1 - (f + v)) * V;
            return r[0] = Q, r[1] = y, r[2] = b, r[3] = 0, r[4] = R, r[5] = _, r[6] = z, r[7] = 0, r[8] = q, r[9] = re, r[10] = N, r[11] = 0, r[12] = e.x + $ - (Q * $ + R * B + q * W), r[13] = e.y + B - (y * $ + _ * B + re * W), r[14] = e.z + W - (b * $ + z * B + N * W), r[15] = 1, this
        }
    }
    class k {
        constructor(e = 0, t = e) {
    ...
    class ne {
        constructor(e, {
            ...
            if (this.type = "Texture", e = e && e.renderer || e, !e || e.type !== "Renderer") C(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                e.production || C(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined");
                return
            }
            if (this.renderer = e, this.gl = this.renderer.gl, this.uuid = Me(), this._globalParameters = {
                    ...
                    width: 1,
                    height: 1
                }, this.scale = new k(1), this.scale.onChange(() => this.resize()), this.offset = new k, this.offset.onChange(() => this.resize()), this._loader = i, this._sourceLoaded = !1, this._uploaded = !1, this._willUpdate = !1, this.shouldUpdate = !1, this._forceUpdate = !1, this.userData = {}, this._canDraw = !1, s) {
...
gl.LINEAR filtering will be used instead`), this.parameters.magFilter = this.gl.LINEAR), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MAG_FILTER, this.parameters.magFilter), this._state.magFilter = this.parameters.magFilter);
        ...
        _getSizes() {
            ...
            const e = this._parent.scale ? Ae.set(this._parent.scale.x, this._parent.scale.y) : Ae.set(1, 1),
        ...
        setScale(e) {
            ...
            e.sanitizeNaNValuesWith(this.scale).max(Ae.set(.001, .001)), e.equals(this.scale) || (this.scale.copy(e), this.resize())
        }
        setOffset(e) {
            if (!e.type || e.type !== "Vec2") {
        ...
        _updateTextureMatrix(e) {
            ...
            t.x /= this.scale.x, t.y /= this.scale.y, this._textureMatrix.matrix = ft.setFromArray([t.x, 0, 0, 0, 0, t.y, 0, 0, 0, 0, 1, 0, (1 - t.x) / 2 + this.offset.x, (1 - t.y) / 2 + this.offset.y, 0, 1]), this._updateMatrixUniform()
        }
    ...
    class Be {
        constructor(e, t = "anonymous") {
            if (this.type = "TextureLoader", e = e && e.renderer || e, !e || e.type !== "Renderer") C(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                C(this.type + ": Renderer WebGL context is undefined", e);
                return
            }
        ...
        loadImage(e, t = {}, s, i) {
            ...
            if (this._parent && (a = Object.assign(a, this._parent._texturesOptions)), a.loader = this, r) {
                ...
                const d = new ne(this.renderer, a);
            ...
            const o = new ne(this.renderer, a),
        ...
        loadVideo(e, t = {}, s, i) {
            ...
            const h = new ne(this.renderer, a),
        ...
        loadCanvas(e, t = {}, s) {
            ...
            const r = new ne(this.renderer, i);
    ...
    class gt {
        constructor(e, t = "Mesh", {
            ...
            if (this.type = t, e = e && e.renderer || e, (!e || e.type !== "Renderer") && (C(this.type + ": Curtains not passed as first argument or Curtains Renderer is missing", e), setTimeout(() => {
                    this._onErrorCallback && this._onErrorCallback()
                }, 0)), this.renderer = e, this.gl = this.renderer.gl, !this.gl) {
                this.renderer.production || C(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined"), setTimeout(() => {
                    this._onErrorCallback && this._onErrorCallback()
                }, 0);
                return
            }
            this._canDraw = !1, this.renderOrder = d, this._depthTest = c, this.cullFace = u, this.cullFace !== "back" && this.cullFace !== "front" && this.cullFace !== "none" && (this.cullFace = "back"), this.textures = [], this._texturesOptions = Object.assign({
                ...
                magFilter: this.gl.LINEAR
            }, f), this.crossOrigin = p, !r && s && document.getElementById(s) && (r = document.getElementById(s).innerHTML), !a && i && document.getElementById(i) && (a = document.getElementById(i).innerHTML), this._initMesh(), o = parseInt(o), l = parseInt(l), this._geometry = new ct(this.renderer, {
                width: o,
                height: l
        ...
        _initMesh() {
            this.uuid = Me(), this.loader = new pt(this.renderer, this, {
                sourcesLoaded: 0,
                initSourcesToLoad: 0,
                complete: !1,
                onComplete: () => {
        ...
        _restoreContext() {
            this._canDraw = !1, this._matrices && (this._matrices = null), this._program = new Ve(this.renderer, {
                parent: this,
        ...
        createTexture(e = {}) {
            const t = new ne(this.renderer, Object.assign(e, this._texturesOptions));
...
`, r), i && i(r, a)
    ...
    class _t extends gt {
        ...
        mouseToPlaneCoords(e) {
            const t = this.scale ? this.scale : mt.set(1, 1),
                s = We.set((this._boundingRect.document.width - this._boundingRect.document.width * t.x) / 2, (this._boundingRect.document.height - this._boundingRect.document.height * t.y) / 2),
                i = {
    ...
    class xt {
        constructor({
            ...
            this.position = new P, this.projectionMatrix = new J, this.worldMatrix = new J, this.viewMatrix = new J, this._shouldUpdate = !1, this.setSize(), this.setPerspective(e, t, s, i, r, a)
        }
        setFov(e) {
        ...
        updateProjectionMatrix() {
            ...
            this.projectionMatrix.setFromArray([o, 0, 0, 0, 0, l, 0, 0, d, c, u, -1, 0, 0, f, 0])
        }
        forceUpdate() {
    ...
    class He extends _t {
        constructor(e, t, {
            ...
            super(e, t, "Plane", {
                ...
                texturesOptions: f,
                crossOrigin: p
            }), this.gl && (this.index = this.renderer.planes.length, this.target = null, this.alwaysDraw = m, this._shouldDraw = !0, this.visible = v, this._transparent = T, this.drawCheckMargins = w, this.autoloadSources = E, this.watchScroll = M, this._updateMVMatrix = !1, this.camera = new xt({
                fov: A,
        ...
        _initTransformValues() {
            this.rotation = new P, this.rotation.onChange(() => this._applyRotation()), this.quaternion = new be, this.relativeTranslation = new P, this.relativeTranslation.onChange(() => this._setTranslation()), this._translation = new P, this.scale = new P(1), this.scale.onChange(() => {
                this.scale.z = 1, this._applyScale()
            }), this.transformOrigin = new P(.5, .5, 0), this.transformOrigin.onChange(() => {
        ...
        _setWorldTransformOrigin() {
            this._boundingRect.world.transformOrigin = new P((this.transformOrigin.x * 2 - 1) * this._boundingRect.world.width, -(this.transformOrigin.y * 2 - 1) * this._boundingRect.world.height, this.transformOrigin.z)
        }
        _documentToWorldSpace(e) {
            return Pt.set(e.x * this.renderer.pixelRatio / this.renderer._boundingRect.width * this._boundingRect.world.ratios.width, -(e.y * this.renderer.pixelRatio / this.renderer._boundingRect.height) * this._boundingRect.world.ratios.height, e.z)
        }
        _setWorldSizes() {
        ...
        setScale(e) {
            ...
            e.sanitizeNaNValuesWith(this.scale).max(yt.set(.001, .001)), (e.x !== this.scale.x || e.y !== this.scale.y) && (this.scale.set(e.x, e.y, 1), this._applyScale())
        }
        _applyScale() {
            for (let e = 0; e < this.textures.length; e++) this.textures[e].resize();
        ...
        _getNearPlaneIntersections(e, t, s) {
            ...
            if (s.length === 1) s[0] === 0 ? (t[0] = this._getIntersection(t[1], G.set(.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[3], j.set(-1, -.95, 0).applyMat4(i)))) : s[0] === 1 ? (t[1] = this._getIntersection(t[0], G.set(-.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[2], j.set(1, -.95, 0).applyMat4(i)))) : s[0] === 2 ? (t[2] = this._getIntersection(t[3], G.set(-.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[1], j.set(1, .95, 0).applyMat4(i)))) : s[0] === 3 && (t[3] = this._getIntersection(t[2], G.set(.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[0], j.set(-1, .95, 0).applyMat4(i))));
            else if (s.length === 2) s[0] === 0 && s[1] === 1 ? (t[0] = this._getIntersection(t[3], G.set(-1, -.95, 0).applyMat4(i)), t[1] = this._getIntersection(t[2], j.set(1, -.95, 0).applyMat4(i))) : s[0] === 1 && s[1] === 2 ? (t[1] = this._getIntersection(t[0], G.set(-.95, 1, 0).applyMat4(i)), t[2] = this._getIntersection(t[3], j.set(-.95, -1, 0).applyMat4(i))) : s[0] === 2 && s[1] === 3 ? (t[2] = this._getIntersection(t[1], G.set(1, .95, 0).applyMat4(i)), t[3] = this._getIntersection(t[0], j.set(-1, .95, 0).applyMat4(i))) : s[0] === 0 && s[1] === 3 && (t[0] = this._getIntersection(t[1], G.set(.95, 1, 0).applyMat4(i)), t[3] = this._getIntersection(t[2], j.set(.95, -1, 0).applyMat4(i)));
            else if (s.length === 3) {
                let r = 0;
                for (let a = 0; a < e.length; a++) s.includes(a) || (r = a);
                t = [t[r]], r === 0 ? (t.push(this._getIntersection(t[0], G.set(-.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], j.set(-1, .95, 0).applyMat4(i)))) : r === 1 ? (t.push(this._getIntersection(t[0], G.set(.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], j.set(1, .95, 0).applyMat4(i)))) : r === 2 ? (t.push(this._getIntersection(t[0], G.set(.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], j.set(1, -.95, 0).applyMat4(i)))) : r === 3 && (t.push(this._getIntersection(t[0], G.set(-.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], j.set(-1 - .95, 0).applyMat4(i))))
            } else
        ...
        mouseToPlaneCoords(e) {
            if (Ne.setAxisOrder(this.quaternion.axisOrder), Ne.equals(this.quaternion) && Et.equals(this.transformOrigin)) return super.mouseToPlaneCoords(e); {
                const t = {
                ...
                if (Math.abs(h) >= 1e-4) {
                    const o = this._matrices.world.matrix.getInverse().multiply(this.camera.viewMatrix),
                        ...
                        d = At.set(this._translation.x - l.x, this._translation.y - l.y, this._translation.z - l.z);
    ...
    class Ce {
        constructor(e, {
            ...
            if (this.type = "RenderTarget", e = e && e.renderer || e, !e || e.type !== "Renderer") C(this.type + ": Renderer not passed as first argument", e);
            else if (!e.gl) {
                e.production || C(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined");
                return
            }
        ...
        _createFrameBuffer() {
            this._frameBuffer = this.gl.createFramebuffer(), this.renderer.bindFrameBuffer(this, !0), this.textures.length ? (this.textures[0]._parent = this, this.textures[0]._restoreContext()) : new ne(this.renderer, this._texturesOptions).addParent(this), this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER, this.gl.COLOR_ATTACHMENT0, this.gl.TEXTURE_2D, this.textures[0]._sampler.texture, 0), this._depth && (this._depthBuffer = this.gl.createRenderbuffer(), this._bindDepthBuffer()), this.renderer.bindFrameBuffer(null)
        }
        getTexture() {
    ...
    class Ft extends He {
        constructor(e, t, {
            ...
            this.renderer.scene.removePlane(this), this.type = "PingPongPlane", this.renderer.scene.addPlane(this), this.readPass = new Ce(e, {
                depth: !1,
                clear: !1,
                texturesOptions: p
            }), this.writePass = new Ce(e, {
                depth: !1,
                clear: !1,
                texturesOptions: p
            }), this.createTexture({
    ...
    let Pe, ue, ke = !1,
        ae = window.innerHeight || document.documentElement.clientHeight,
        ...
        oe, le;
    const pe = .001;
    typeof document.hidden < "u" ? (Pe = "hidden", ue = "visibilitychange") : typeof document.msHidden < "u" ? (Pe = "msHidden", ue = "msvisibilitychange") : typeof document.webkitHidden < "u" && (Pe = "webkitHidden", ue = "webkitvisibilitychange");
    ...
    function Ie(n, e, t, s, i) {
        if (t.length > 1) {
            ...
            const c = Math.cos(r) * o,
                u = Math.sin(r) * l;
            if (i === "linear" && (d = n.createLinearGradient(a - c, h - u, a + c, h + u)), i === "conic") {
    ...
    function Ge(n) {
        const e = {
            ...
            easeInOutBack: t => {
                const s = 2.5949095;
                return t < .5 ? Math.pow(2 * t, 2) * ((s + 1) * 2 * t - s) / 2 : (Math.pow(2 * t - 2, 2) * ((s + 1) * (t * 2 - 2) + s) + 2) / 2
            }
        };
        if (e[n]) return e[n];
        if (typeof n == "string" && (n.includes("=>") || n.includes("function") || n.includes("x"))) {
            const t = new Function("return " + n)();
            if (t) return t
        }
        return e.linear
    }
    ...
    function de(n) {
        ...
        const e = n.hasOwnProperty("trackMouse") && n.trackMouse !== 0 || n.hasOwnProperty("axisTilt") && n.axisTilt !== 0 || n.hasOwnProperty("trackMouseMove") && n.trackMouseMove !== 0,
    ...
    function Lt(n, e) {
        ...
        s.src = ge("aHR0cHM6Ly9hc3NldHMudW5pY29ybi5zdHVkaW8vbWVkaWEvbWFkZV9pbl91c19zbWFsbF93ZWIuc3Zn"), s.alt = ge("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv"), s.style = "width: 170px; height: auto;", t.appendChild(s), e.appendChild(t)
    }

    function je(n, e) {
        if (n.noTextAsHtml || !e) return;
    ...
    function Te() {
        ...
        let n = S.filter(t => t.getDynamicLayers().length > 0);
        const e = t => {
            let s = !1;
            n.forEach(i => {
                i.isInView && i.initialized ? (i.rendering = !0, t - (i.lastTime || 0) >= i.frameDuration && !i.paused && (i.renderFrame(), i.lastTime = t), s = !0) : i.rendering = !1
            }), (!fe || t - fe > 64) && (X = window.scrollY || window.pageYOffset, he = X - Fe, Fe = X, fe = t, (he > 1e3 || he < 0 && !Fe && !X) && Le()), s ? (Yt(), oe = requestAnimationFrame(e)) : cancelAnimationFrame(oe)
        };
        n.length ? oe = requestAnimationFrame(e) : cancelAnimationFrame(oe)
    }
    ...
    function Re(n, e) {
        return n.type === "Vec2" ? n = new k(n._x, n._y) : n.type === "Vec3" && (n = new P(n._x, n._y, n._z)), n
    }

    function Ee(n, e, t) {
        (n == null ? void 0 : n.type) && ((n == null ? void 0 : n.type) === "Vec2" || (n == null ? void 0 : n.type) === "Vec3") ? (e.value.x = n.x, t === "pos" ? e.value.y = 1 - n.y : e.value.y = n.y, n.type === "Vec3" && (e.value.z = n.z)) : e.value = n
    }
    ...
    class Ut {
        constructor({
            ...
            D(this, "id", me());
            this.prop = e, this.transition = i, this.complete = !1, this.progress = 0, this.uniformData = a, this.value = Re(t), this.endValue = s !== void 0 ? Re(s || 0) : null, this.lastTick = void 0, this.initialized = !1, this.startTime = null, this.breakpoints = r || [], this.loop = h, this.loopDelay = o, this.easeFunction = Ge(this.transition.ease)
        }
        updateEffect(e, t) {
            if (e = this.endValue ? ? e, e === void 0) return !1;
            const s = performance.now(),
                i = (this.startTime || t) + this.transition.delay,
                r = s - i;
            if (r < 0) return !1;
            if (this.loop !== "none") {
                const h = this.transition.duration + this.loopDelay,
                    o = r % h;
                if (o > this.transition.duration) return !1;
                const l = o / this.transition.duration,
                    d = Math.floor(r / h);
                let c = l;
                return this.loop === "reverse" && d % 2 === 1 && (c = 1 - l), this.progress = this.easeFunction(c), this.lastTick = s, _e(this.value, e, this.progress)
            }
            const a = Math.max(0, Math.min(1, r / this.transition.duration));
            return this.progress = this.easeFunction(a), this.progress === 0 ? !1 : a >= 1 ? (this.complete = !0, this.progress = 0, e) : (this.lastTick = s, this.complete ? !1 : _e(this.value, e, this.progress))
        }
        resetState() {
    ...
    class Vt {
        constructor({
            ...
            D(this, "id", me());
            this.prop = e, this.progress = 0, this.momentum = r, this.range = s, this.offset = i, this.mode = h, this.delta = o, this.absScrollValue = l, this.uniformData = a, this.value = Re(t), this.lastTick = void 0, this.breakpoints = d || []
        }
        updateEffect(e, {
            top: t,
            height: s,
            ...
            if (i && (t -= X), this.mode === "scrollIntoView") {
                const r = t + X - ae * this.offset,
                    a = r + (ae + s) * this.range;
                let h = (X - r) / (a - r),
                    o = Math.max(0, Math.min(1, h));
                return this.lastTick !== void 0 && (o = we(o, this.lastTick, this.momentum * 2), Math.abs(this.lastTick - o) < pe) ? !1 : (this.lastTick = o, _e(e, this.value, o))
            } else if (this.mode === "whileScrolling") {
                let r = he * this.delta;
                return this.absScrollValue && (r = Math.abs(r)), this.lastTick !== void 0 && (r = we(r, this.lastTick, this.momentum * 2), Math.abs(r) < pe) ? !1 : (this.lastScrollPos = X, this.lastTick = r, _e(e, this.value, r))
            }
            return !1
        }
        resetState() {
    ...
    class Bt {
        constructor({
            ...
            D(this, "id", me());
            this.prop = e, this.transition = s, this.progress = 0, this.rawProgress = 0, this.lastProgress = null, this.value = Re(t), this.uniformData = r, this.triggerOnElement = a !== void 0 ? a : 1, this.breakpoints = i || [], this.easeFunction = Ge(this.transition.ease)
        }
        updateEffect(e, t, s) {
            var u;
            if (e === void 0) return !1;
            const i = (u = s == null ? void 0 : s.getParent) == null ? void 0 : u.call(s),
                r = performance.now();
            ...
            a ? this.rawProgress = Math.max(0, this.rawProgress - l) : (this.lastEnterTime !== t && (this.lastProgress = this.rawProgress || 0), this.rawProgress = Math.min(1, this.lastProgress + l));
            const d = this.easeFunction(this.rawProgress),
                c = Math.abs(this.progress - d) > pe;
            return this.progress = d, !t && !c ? !1 : (!t && this.transition.forwardsOnly && (this.progress = 0, this.rawProgress = 0), this.lastTick = r, this.lastEnterTime = t, c ? _e(e, this.value, this.progress) : !1)
        }
        resetState() {
            this.progress = 0
        }
    ...
    function Wt(n) {
        return n.forEach(e => {
            var t, s;
            for (let i in e.props)((t = e.props[i]) == null ? void 0 : t.type) === "Vec2" ? e.props[i] = new k(e.props[i]._x, e.props[i]._y) : ((s = e.props[i]) == null ? void 0 : s.type) === "Vec3" ? e.props[i] = new P(e.props[i]._x, e.props[i]._y, e.props[i]._z) : typeof e.props[i] == "object" && (e.props[i] = te(e.props[i]))
        }), n
    }
    class Ye {
        constructor(e, t) {
            ...
            this.locked = e.locked || !1, this.aspectRatio = e.aspectRatio || 1, this.layerName = e.layerName || "", this.data = e.data || {}, this.userDownsample = e.userDownsample || 1, this.breakpoints = Wt(e.breakpoints || []), this.local.sceneId = t, this.local.id = me(), this.states = {
        ...
        state() {
            return S.find(e => e.id === this.local.sceneId) || this.initOptions
        }
        getIndex() {
        ...
        setBreakpointValues() {
            ...
            for (let r in s)
                if (this.hasOwnProperty(r)) {
                    let a = s[r];
                    a != null && a.type ? (this[r].x = a._x, this[r].y = a._y, a._z !== void 0 && (this[r].z = a._z)) : this[r] = a
                }
            this.local.bpProps = s
        }
        updateStateEffects() {
            var i, r, a, h;
            if (!this.states.appear.some(o => !o.complete) && !((i = this.states) != null && i.scroll.length) && !((r = this.states) != null && r.hover.length)) return;
            this.local.uniformUpdatesPool || (this.local.uniformUpdatesPool = {}), this.local.updatedProps ? this.local.updatedProps.clear() : this.local.updatedProps = new Set, this.local.hasUpdates = !1;
            const e = this.state();
            let t = performance.now();
            (!this.local.cachedBreakpoint || this.local.cachedBreakpoint !== ((a = e.currentBreakpoint) == null ? void 0 : a.name)) && (this.local.cachedBreakpoint = (h = e.currentBreakpoint) == null ? void 0 : h.name);
            const s = o => !o.breakpoints || o.breakpoints.length === 0 ? !0 : o.breakpoints.find(l => l === this.local.cachedBreakpoint);
            e.isInView && (this.local.createdAt === null && (this.local.createdAt = t), this.states.appear.forEach(o => {
                if (!s(o)) return;
                let l = o.startTime || this.local.createdAt;
                if (!o.initialized) {
                    const c = [...this.states.appear.filter(u => u.prop === o.prop)].sort((u, f) => (u.transition.delay || 0) - (f.transition.delay || 0))[0];
                    (c == null ? void 0 : c.id) === o.id && (this.local.uniformUpdatesPool[o.prop] = o.value, this.local.hasUpdates = !0, this.local.updatedProps.add(o.prop)), o.initialized = !0, l || (o.startTime = t)
                }
                e != null && e.pauseTime && (l += Math.abs(e == null ? void 0 : e.pauseTime));
                const d = o.updateEffect(this[o.prop], l);
                d !== !1 && (this.local.uniformUpdatesPool[o.prop] = d, this.local.hasUpdates = !0, this.local.updatedProps.add(o.prop)), this.isElement && o.complete && this.local.stateEffectProps && this.local.stateEffectProps[o.prop] && delete this.local.stateEffectProps[o.prop]
            })), this.states.hover.forEach(o => {
                if (!s(o)) return;
                const l = o.updateEffect(this[o.prop], e.mouse.enterTime, this);
                l !== !1 && (this.local.uniformUpdatesPool[o.prop] = l, this.local.hasUpdates = !0, this.local.updatedProps.add(o.prop))
            }), this.states.scroll.forEach(o => {
                var c;
                if (!s(o)) return;
                const l = e.bbox;
                if (!l) return;
                const d = o.updateEffect(this[o.prop], {
                    top: e.isFixed ? 0 : (c = e.bbox) == null ? void 0 : c.top,
                    height: l.height / 2,
                    isFixed: e.isFixed
                });
                d !== !1 && (this.local.uniformUpdatesPool[o.prop] = d, this.local.hasUpdates = !0, this.local.updatedProps.add(o.prop))
            }), this.local.hasUpdates && (this.getPlanes().forEach(o => {
                var l;
                for (let d of this.local.updatedProps) {
                    const c = this.local.uniformUpdatesPool[d];
                    c !== void 0 && ((l = o.uniforms[d]) == null ? void 0 : l.lastValue) !== c && (o.uniforms[d] && Ee(c, o.uniforms[d], d), this.updateStateEffectProperty(d, c))
                }
        ...
        invalidatePerformanceCaches() {
            this.local.isDynamicCache = void 0, this.local.cachedBreakpoint = void 0, this.local.lastCalculatedMousePos = void 0, this.local.lastCalculatedMouseValues = void 0
        }
    }
    ...
    let ze = class extends Ye {
        ...
        resize() {
            ...
            if (this.local.canvas) {
                ...
                this.local.canvas.width = t.canvasWidth * s, this.local.canvas.height = t.canvasHeight * s, this.local.ctx.scale(s, s)
            }
            this.render(), this.layerType === "text" && je(this, this.state().element)
        }
        dispose() {
            this.local.canvas && (this.local.canvas.width = 1, this.local.canvas.height = 1, this.local.canvas = null), this.local.ctx && (this.local.ctx = null), this.invalidatePerformanceCaches()
        }
        box() {
            const t = ce(this.anchorPoint),
                {
                    width: s,
                    height: i
        ...
        getAbsolutePosition() {
            ...
            let r = ((d = (l = this.local) == null ? void 0 : l.stateEffectProps) == null ? void 0 : d.left) ? ? this.left,
                a = ((u = (c = this.local) == null ? void 0 : c.stateEffectProps) == null ? void 0 : u.top) ? ? this.top,
                h = this.leftMode === "fixed" ? r : r * s,
                o = this.topMode === "fixed" ? a : a * i;
            return h = +h.toFixed(1), o = +o.toFixed(1), {
                left: h,
                top: o
            }
        }
        getAbsoluteDimensions() {
            ...
            let h = ((d = (l = this.local) == null ? void 0 : l.stateEffectProps) == null ? void 0 : d.width) ? ? this.width,
                o = ((u = (c = this.local) == null ? void 0 : c.stateEffectProps) == null ? void 0 : u.height) ? ? this.height;
            return this.widthMode !== "auto" && (s = this.widthMode === "fixed" ? h : h * r, this.heightMode === "auto" && (i = s / (this.aspectRatio || 1), this.height = this.widthMode === "fixed" ? i : i / a)), this.heightMode !== "auto" && (i = this.heightMode === "fixed" ? o : o * a, this.widthMode === "auto" && (s = i * (this.aspectRatio || 1), this.width = this.widthMode === "fixed" ? s : s / r)), this.layerType === "text" && (i = this.height), {
                width: s,
                height: i
            }
        }
    ...
    class Nt extends ze {
        ...
        unpackageType() {
            return this.fill = te(this.fill), this.stroke = te(this.stroke), this.render(), this
        }
        render() {
            var m, v, T, w;
            ...
            const o = ce(this.anchorPoint);
            let l = ((m = this.local.stateEffectProps) == null ? void 0 : m.borderRadius) ? ? this.borderRadius,
                d = ((v = this.local.stateEffectProps) == null ? void 0 : v.strokeWidth) ? ? this.strokeWidth,
                c = ((T = this.local.stateEffectProps) == null ? void 0 : T.gradientAngle) ? ? this.gradientAngle,
                u = ((w = this.local.stateEffectProps) == null ? void 0 : w.rotation) ? ? this.rotation,
                f = i - o.x * a,
                p = r - o.y * h;
            if (t.clearRect(0, 0, s.canvasWidth, s.canvasHeight), t.beginPath(), this.fitToCanvas) t.rect(0, 0, s.canvasWidth, s.canvasHeight), t.fillStyle = Ie(t, {
                width: s.canvasWidth,
                height: s.canvasHeight
            }, this.fill, c, this.gradientType);
            else {
                if (t.save(), t.translate(f + a / 2, p + h / 2), t.rotate(u * 2 * Math.PI), t.translate(-a / 2, -h / 2), this.type === "rectangle") {
                    let E = l * Math.min(Math.abs(a), Math.abs(h)) / 2;
                    this.drawRoundedRect(t, 0, 0, a, h, E)
                } else this.type === "circle" ? t.ellipse(a / 2, h / 2, Math.abs(a) / 2, Math.abs(h) / 2, 0, 0, 2 * Math.PI) : this.type === "polygon" && this.drawPolygon(t, Math.abs(a), Math.abs(h), this.numSides);
                t.fillStyle = Ie(t, this.box(), this.fill, c, this.gradientType)
            }
            t.fill(), d && (t.strokeStyle = this.stroke[0], t.lineWidth = d, t.stroke()), t.restore()
        }
        drawRoundedRect(t, s, i, r, a, h) {
            t.beginPath(), t.moveTo(s + h, i), t.arcTo(s + r, i, s + r, i + a, h), t.arcTo(s + r, i + a, s, i + a, h), t.arcTo(s, i + a, s, i, h), t.arcTo(s, i, s + r, i, h), t.closePath()
        }
        drawPolygon(t, s, i, r) {
            t.beginPath();
            for (let a = 0; a < r; a++) {
    ...
    class Ht extends Ye {
        ...
        unpackage() {
            for (let t in this) this[t] && this[t].type && (this[t].type === "Vec2" ? this[t] = new k(this[t]._x, this[t]._y) : this[t].type === "Vec3" && (this[t] = new P(this[t]._x, this[t]._y, this[t]._z)));
            return this
        }
        getParent() {
    ...
    class Gt extends ze {
        ...
        unpackage() {
            return this.effects = te(this.effects), this
        }
        loadImage() {
            const t = new Image;
            t.crossOrigin = "Anonymous", t.addEventListener("load", () => {
                const s = this.state();
                this.local.img = t, this.render = this.renderImage, this.render(), s.renderFrame && s.renderFrame(), this.local.loaded = !0
            }, !1), t.src = this.src
        }
        renderImage() {
            var d, c;
            ...
            let {
                ...
                width: a,
                height: h
            } = this.box(), o = s.canvasWidth, l = s.canvasHeight;
            if (this.fitToCanvas) {
                let u = this.local.img.width / this.local.img.height;
                o / l < u ? (h = l, a = l * u) : (a = o, h = o / u);
                const p = (o - a) / 2,
                    m = (l - h) / 2;
                t.drawImage(this.local.img, p, m, a, h)
            } else {
                const u = ce(this.anchorPoint),
                    f = (((c = this.local.stateEffectProps) == null ? void 0 : c.rotation) ? ? this.rotation) * 2 * Math.PI;
                let p = u.x * a,
                    m = u.y * h;
                t.save();
                let v = a / 2,
                    ...
                    w = i - p + v,
                    E = r - m + T;
                t.translate(w, E), t.rotate(f), t.drawImage(this.local.img, -v, -T, a, h), t.restore()
            }
        }
        render() {}
    }
    class jt extends ze {
        constructor(t, s, i, r) {
            ...
            this.breakpoints.length && this.setBreakpointValues(), this.isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), Object.keys(t).length && this.createLocalCanvas(), this.loadFont()
        }
        default (t) {
            return {
                fill: t.fill || ["#ffffff"],
                ...
                gradientAngle: t.gradientAngle || t.gradAngle || 0,
                gradientType: t.gradientType || t.gradType || "linear",
                noTextAsHtml: t.noTextAsHtml || !1
            }
        }
        unpackage() {
            return this.fill = te(this.fill), this.effects = te(this.effects), this
        }
        loadFont() {
            var o;
            ...
            if (Array.from(document.fonts).some(l => l.family === this.fontFamily && l.style === t && s(l.weight) === i && l.status === "loaded") || !((o = this.fontCSS) != null && o.src)) {
                this.handleFontLoaded();
                return
            }
            let a = this.fontCSS.src.split(" ").join("%20");
            const h = new FontFace(this.fontFamily, `url(${a})`, {
                style: t,
                weight: i
            });
        ...
        getAbsoluteFontValues(t) {
            var h, o, l, d, c, u;
            const s = ((o = (h = this.local) == null ? void 0 : h.stateEffectProps) == null ? void 0 : o.fontSize) || this.fontSize,
                i = ((d = (l = this.local) == null ? void 0 : l.stateEffectProps) == null ? void 0 : d.lineHeight) || this.lineHeight,
                r = ((u = (c = this.local) == null ? void 0 : c.stateEffectProps) == null ? void 0 : u.letterSpacing) || this.letterSpacing,
        ...
        render() {
            var B, W, Q;
            if (!((B = this.local) != null && B.ctx)) return;
            let t = this.local.ctx,
                {
                    left: s,
                    top: i,
            ...
            const a = ce(this.anchorPoint),
                h = ((Q = (W = this.local) == null ? void 0 : W.stateEffectProps) == null ? void 0 : Q.rotation) || this.rotation;
            let o = this.state(),
                l = this.height,
                d = s - a.x * r,
                c = i - a.y * l,
                ...
                T = /^\d+$/.test(this.fontStyle) ? this.fontStyle : "400";
            t.clearRect(0, 0, o.canvasWidth, o.canvasHeight), t.font = `${v} ${T} ${f}px/${p}px ${this.fontFamily}, -apple-system, BlinkMacSystemFont, Helvetica, Arial`, this.isSafari || (t.textAlign = this.textAlign, t.letterSpacing = m + "px");
            const w = t.measureText("m").width;
            r = Math.max(r, w), t.save();
            let E = d + r / 2,
                M = c + l / 2;
            t.translate(E, M), t.rotate(h * 360 * Math.PI / 180), t.translate(-E, -M), this.textAlign === "center" && (d += r / 2), this.textAlign === "right" && (d += r), t.fillStyle = Ie(t, this.box(), this.fill, this.gradientAngle, this.gradientType);
            const A = (y, b, R, _, z, q, re) => {
                    let N = b.split("").reduce((L, ee, ss) => L + y.measureText(ee).width + (ss < b.length - 1 ? z : 0), 0),
                        H;
                    if (q === "center" ? H = R + (re - N) / 2 - re / 2 : H = R, q === "right")
                        for (let L = b.length - 1; L >= 0; L--) {
                            const ee = b[L];
                            H -= y.measureText(ee).width, y.fillText(ee, H, _), L > 0 && (H -= z)
                        } else
                            for (let L = 0; L < b.length; L++) y.fillText(b[L], H, _), H += y.measureText(b[L]).width + z
                },
                F = (y, b) => {
                    let R = c + p * b + p / 2 + f / 3;
                    this.isSafari ? A(t, y, d, R, m, this.textAlign, r) : t.fillText(y, d, R)
                },
                x = this.textContent ? this.textContent.split(`
`) : [""];
            let V = x.length;
            const $ = (y, b, R) => b.split("").reduce((z, q, re) => (z += y.measureText(q).width, re < b.length - 1 && (z += R), z), 0);
            for (let y = 0; y < V; y++) {
                let b = "",
                    R = x[y].split(/(\s|\n)/);
                for (let _ = 0; _ < R.length; _++) {
                    const z = R[_],
                        q = b + z;
                    if ((this.isSafari && m ? $(t, q, m) : t.measureText(q).width) > r || z === `
`) {
                        if (b !== "") x[y] = b.trim(), _ !== R.length - 1 ? (x.splice(y + 1, 0, R.slice(_).join("")), V++) : z !== `
` && x.push(z);
                        else {
                            let N = z,
                                H = y;
                            for (; N.length > 0;) {
                                let L = "";
                                for (let ee = 0; ee < N.length && (t.measureText(L + N[ee]).width <= r || ee == 0); ee++) L += N[ee];
                                N = N.slice(L.length), x[H] = L.trim(), N.length > 0 && (x.splice(H + 1, 0, N), H++, V++)
                            }
                            R.slice(_ + 1).length > 0 && (x[H] += R.slice(_ + 1).join(""))
                        }
                        break
                    } else b = q;
                    _ === R.length - 1 && (x[y] = b.trim())
                }
            }
            x.forEach((y, b) => {
                F(y, u), b < x.length - 1 && u++
            }), t.translate(-(d + r / 2), -(c + l / 2)), t.restore(), this.height = p * u + p
        }
    }

    function $e() {
        let n = performance.now();
        document[Pe] ? (cancelAnimationFrame(oe), S.forEach(e => {
            e.pauseTime = n
        })) : (Te(), S.forEach(e => {
            e.pauseTime = e.pauseTime - n, e.curtain.planes.forEach(t => {
                t.videos.forEach(s => {
                    s.play()
                })
            })
    ...
    function Xt() {
        ae = window.innerHeight || document.documentElement.clientHeight, K = window.innerWidth || document.documentElement.clientWidth, S.filter(n => n.initialized).forEach(n => {
            n.refresh()
        }), Le()
    }
    ...
    function qe(n, e, t = 50) {
        const s = e || n.getBoundingClientRect(),
            i = s.top >= -t && s.top <= ae + t || s.bottom >= -t && s.bottom <= ae + t || s.top <= 0 && s.bottom >= ae,
            r = s.left >= -t && s.left <= K + t || s.right >= -t && s.right <= K + t || s.left <= 0 && s.right >= K;
        return i && r
    }

    function Le() {
        S.filter(n => n.getDynamicLayers().length).forEach(n => {
            let e = n.element.getBoundingClientRect();
            n.scrollY = X, n.lastBbox && (Math.abs(e.top - n.lastBbox.top) === 0 && he > 0 ? (n.fixedCounter = (n.fixedCounter || 0) + 1, n.fixedCounter > 3 && (n.isFixed = !0)) : n.fixedCounter = 0), n.lastBbox = n.bbox, n.bbox = e
        })
    }

    function Qe(n) {
        const e = S.filter(i => i.getDynamicLayers().length),
            t = S.filter(i => i.rendering);
        e.length && !t.length && Te();
        const s = performance.now();
        (!fe || s - fe > 64) && Le(), e.forEach(i => {
            if (qe(i.element, i.bbox, 100)) {
                if (!i.isInView) {
                    i.isInView = !0, i.pauseTime = i.pauseTime - s;
                    const a = i.element.offsetWidth > 0 && i.element.offsetHeight > 0;
                    a && i.curtain ? i.resize() : a || requestAnimationFrame(() => {
                        i.element.offsetWidth > 0 && i.element.offsetHeight > 0 && i.curtain && i.resize()
                    }), i.lazyLoad && !i.initialized && !i.initializing && i.initializePlanes()
                }
            } else i.isInView && (i.isInView = !1, i.pauseTime = s)
        })
    }
    ...
    function Yt() {
        ...
        S.forEach(e => {
            var t, s, i, r, a, h;
            if (e.isInView && ((s = (t = e.curtain) == null ? void 0 : t.planes) != null && s.find(o => o.uniforms.mousePos)) && !(ve() && ((r = (i = e.interactivity) == null ? void 0 : i.mouse) != null && r.disableMobile) || (h = (a = e.interactivity) == null ? void 0 : a.mouse) != null && h.disabled)) {
                e.mouse.pos.y = e.mouse.movePos.y, e.mouse.pos.x = e.mouse.movePos.x, e.mouse.lastPos.x = e.mouse.pos.x, e.mouse.lastPos.y = e.mouse.pos.y;
                let o = e.isFixed ? e.bbox.top : e.bbox.top + e.scrollY,
                    l = e.bbox.left;
                e.mouse.page.x > l && e.mouse.page.y > o && e.mouse.page.x < e.lastBbox.width + l && e.mouse.page.y < e.lastBbox.height + o ? e.mouse.enterTime || (e.mouse.enterTime = n) : e.mouse.enterTime = null
            }
        })
    }

    function Ze(n) {
        S.filter(e => e.isInView).forEach(e => {
    ...
    function Se(n) {
        ...
        S.filter(t => t.isInView && t.initialized).forEach(t => {
            let s = t.bbox;
            Math.abs(he) > 1 && e - t.lastBboxTime > 64 && (s = t.element.getBoundingClientRect(), t.lastBbox = t.bbox, t.bbox = s, t.lastBboxTime = e);
            let i, r;
            n.targetTouches ? (i = n.targetTouches[0].pageX, r = n.targetTouches[0].pageY) : (i = n.pageX, r = n.pageY), t.isFixed && (t.scrollY = 0, n.targetTouches ? r = n.targetTouches[0].clientY : r = n.clientY);
            const a = i - s.left,
                h = r - (s.top + (t.isFixed ? 0 : X));
            t.mouse.page.x = i, t.mouse.page.y = r, t.mouse.movePos.x = a * .5, t.mouse.movePos.y = h * .5, t.mouse.movedInView = !0
        })
    }
    let S = [];
    class $t {
        constructor(e) {
            ...
            D(this, "scrollY", 0);
            D(this, "paused", !1);
            D(this, "lastBboxTime", 0);
            this.id = e.id, this.breakpoints = [{
                name: "Desktop",
                max: 1 / 0,
                min: 992
            }, {
                ...
                max: 575,
                min: 0
            }], this.projectId = e.projectId, this.canvasWidth = e.width || e.element.offsetWidth || K, this.canvasHeight = e.height || e.element.offsetHeight || ae, this.curtain = void 0, this.curtainRafId = void 0, this.dpi = +e.dpi || Math.min(1.5, window.devicePixelRatio), this.element = e.element, this.fps = e.fps || 60, this.name = e.name, this.frameDuration = Math.floor(1e3 / (e.fps || 60)), this.layers = e.layers, this.lazyLoad = e.lazyLoad, this.initialized = !1, this.lasTick = null, this.lastTime = 0, this.rendering = !1, this.bbox = {}, this.isFixed = e.fixed || window.getComputedStyle(this.element).position === "fixed", this.interactivity = {
                mouse: {
                    disableMobile: !1,
                    disabled: !1
                }
        ...
        preloadTextures() {
            this.layers.forEach(e => {
                ...
                if (e.isElement) e.local.canvas ? this.textureLoader.loadCanvas(e.local.canvas, {
                    ...
                    c.userData.hasStateEffects = e.states.appear.length > 0 || e.states.scroll.length > 0 || e.states.hover.length > 0, e.preloadedCanvasTexture = c
                }, c => {
                    console.error("Error loading canvas texture:", c)
                }) : console.error("Error loading canvas");
                else if ((t = e == null ? void 0 : e.texture) != null && t.src || (i = (s = e == null ? void 0 : e.data) == null ? void 0 : s.texture) != null && i.src) {
                    const c = ((r = e == null ? void 0 : e.texture) == null ? void 0 : r.src) || ((h = (a = e == null ? void 0 : e.data) == null ? void 0 : a.texture) == null ? void 0 : h.src),
                        u = ((o = e == null ? void 0 : e.texture) == null ? void 0 : o.sampler) || ((d = (l = e == null ? void 0 : e.data) == null ? void 0 : l.texture) == null ? void 0 : d.sampler) || "uTexture";
                    this.local.preloadedTextures[c] ? this.local.preloadedTextures[c].count++ : (this.local.preloadedTextures[c] = {
                        count: 1,
                        texture: null
                    }, this.textureLoader.loadImage(c, {
                        sampler: u,
                        premultipliedAlpha: !1
                    }, f => {
                        this.local.preloadedTextures[c].texture = f
                    }))
                }
            })
        }
        ...
        destroy() {
            var t, s;
            (t = this.curtain) != null && t.gl && (this.curtain.dispose(), this.curtain = null), this.element && (this.element.removeAttribute("data-us-initialized"), this.element.removeAttribute("data-scene-id"), (s = this.element.querySelector("canvas")) == null || s.remove(), this.element.querySelectorAll("[data-us-text]").forEach(i => {
                i.remove()
            })), this.layers.filter(i => i.dispose).forEach(i => i.dispose()), this.layers = [];
            const e = S.findIndex(i => i.id === this.id);
            e !== -1 && S.splice(e, 1), Te(), S.length || De()
        }
        resize() {
            this.lastBbox = this.bbox, this.bbox = this.element.getBoundingClientRect(), this.setCanvasScale(), this.layers.filter(e => e.isElement).forEach(e => {
                e.resize()
            }), this.currentBreakpoint = this.breakpoints.find(e => K >= e.min && K <= e.max), this.curtain && (this.curtain.resize(), this.curtain.canvas.style.width = this.canvasWidth + "px", this.curtain.canvas.style.height = this.canvasHeight + "px", this.curtain.planes.forEach(e => {
        ...
        refresh() {
            this.initialized = !1, this.layers.forEach(e => {
                ...
                (t = e.states) == null || t.scroll.forEach(i => i.resetState()), (s = e.states) == null || s.appear.forEach(i => {
                    e[i.prop] = i.endValue ? ? e.local.stateEffectProps[i.prop] ? ? e[i.prop]
                }), e.breakpoints.length && (e.setBreakpointValues(), e.local.bpProps && Object.keys(e.local.bpProps).forEach(i => {
                    e.getPlanes().forEach(r => {
                        r.uniforms[i] && Ee(e.local.bpProps[i], r.uniforms[i], i)
                    })
                })), e.preloadedCanvasTexture && (e.preloadedCanvasTexture.shouldUpdate = !0)
            }), requestAnimationFrame(() => {
                this.curtain && (this.curtain.planes.forEach(e => {
                    e._canDraw = !0
                }), this.scrollY = X, this.resize(), this.handlePlaneCreation())
            })
        }
        getDynamicLayers() {
            return this.layers.filter(e => de(e))
        }
        createCurtains() {
            if (this.curtain = new at({
            ...
            this.curtain.onError(e => {
                ...
                console.log("Unicorn.studio scene restored WebGL context"), this.initialized && (this.layers.forEach(e => {
                    e.preloadedCanvasTexture && (e.preloadedCanvasTexture.shouldUpdate = !0)
                }), requestAnimationFrame(() => {
                    this.curtain && (this.curtain.planes.forEach(e => {
                        e._canDraw = !0
        ...
        renderFrame() {
            Ot(this.curtain) ? (this.layers.forEach(e => {
        ...
        getSplitOrderedItems() {
            ...
            if (s) {
                let i = s.parentLayer ? s.getParent() : null,
                    r = i && de(i),
                    a = i && i.effects && i.effects.length && i.getChildEffectItems().filter(h => de(h)).length;
                for (; s && !de(s) && !r && !a;) t++, s = e[t], s && (i = s.parentLayer ? s.getParent() : null, r = i && de(i), a = i && i.effects && i.effects.length && i.getChildEffectItems().filter(h => de(h)).length);
                return {
        ...
        getPassPlane(e, t) {
            var s;
            return (s = this.curtain) == null ? void 0 : s.planes.find(i => i.userData.id === e.local.id && i.userData.passIndex === t)
        }
        getRenderTargets() {
            var e;
        ...
        getPlaneParams(e, t) {
            var h, o, l, d, c;
            let s = (h = e.data) != null && h.heightSegments || (o = e.data) != null && o.widthSegments ? 500 : 1;
            const i = {
                resolution: {
                    name: "uResolution",
                    type: "2f",
                    value: new k(this.canvasWidth, this.canvasHeight)
                },
                mousePos: {
                    name: "uMousePos",
                    type: "2f",
            ...
            e.isElement && (i.sampleBg = {
                ...
                type: "1i",
                value: 1
            }), e.usesPingPong && (i.previousMousePos = {
            ...
            if (e.states && [...e.states.appear, ...e.states.scroll, ...e.states.hover].forEach(u => {
                    i[u.prop] || u.uniformData && (i[u.prop] = u.uniformData, i[u.prop].value = e[u.prop])
                }), (l = e.data) != null && l.uniforms)
                for (let u in e.data.uniforms) {
                    let f = e.data.uniforms[u];
                    i[u] = e.data.uniforms[u], ((d = f.value) == null ? void 0 : d.type) === "Vec3" ? i[u].value = new P(f.value._x, f.value._y, f.value._z) : ((c = f.value) == null ? void 0 : c.type) === "Vec2" ? i[u].value = new k(f.value._x, f.value._y) : typeof f.value == "object" && (i[u].value = te(f.value))
                }
            return {
                fragmentShader: r,
                vertexShader: a,
        ...
        createPlane(e, t, s) {
            var a;
            let i;
            e.isElement ? i = this.getPlaneParams(e) : i = this.getPlaneParams(e, s ? s.index : null), i.watchScroll = !1;
            let r;
            try {
                if (!this.curtain.container) throw new Error("Can't find scene container");
                let h = (s == null ? void 0 : s.downSample) || (s == null ? void 0 : s.index) === 0 && ((a = e.data) == null ? void 0 : a.downSample),
                    o = this.renderingScale;
                if (h && (o = typeof h == "number" ? h : .5, o *= this.renderingScale), e.userDownsample && typeof e.userDownsample == "number" && (o *= e.userDownsample), r = new He(this.curtain, this.curtain.container, i), !r || !r.userData || !r.textures) throw new Error("Plane not properly initialized");
                return r.textures.length = 0, r.userData.id = e.local.id, r.userData.layerType = e.layerType, r.userData.type = e.type, r.userData.downSample = o, r.setRenderOrder(t), r
            } catch (h) {
        ...
        createPingPongPlane(e, t, s) {
            ...
            let i = this.getPlaneParams(e, 1 + ((s == null ? void 0 : s.length) || 0)),
                r = (a = this.curtain) == null ? void 0 : a.planes.find(h => h.type === "PingPongPlane" && h.userData.id === e.local.id);
            if (r) r.setRenderOrder(t);
            else {
                if (r = new Ft(this.curtain, this.curtain.container, i), !r) return;
                r.userData.id = e.local.id, r.userData.pingpong = !0, r.setRenderOrder(t), r.onReady(() => {
                    this.setInitialEffectPlaneUniforms(r, e, e == null ? void 0 : e.getParent(), s), r.userData.isReady = !0
                }).onRender(() => {
        ...
        createEffectPlane(e, t, s) {
            ...
            s && (i.userData.passIndex = s.index, i.userData.length = e.data.passes.length, Object.entries(s).forEach(([a, h]) => {
        ...
        handleMediaTextures(e, t, s) {
            ...
            if ([t.texture, (i = t.data) == null ? void 0 : i.texture].filter(r => r == null ? void 0 : r.src).forEach(r => {
                    ...
                    if ((h = t.compiledFragmentShaders[s.passIndex ? ? 0]) == null ? void 0 : h.includes(r.sampler)) {
                        ...
                        o != null && o.texture ? (o.count > 1 ? (U(e, r.sampler, o.texture), o.count--) : e.addTexture(o.texture), e.userData.textureLoaded = !0) : this.textureLoader.loadImage(r.src, {
                            premultipliedAlpha: !1,
                            sampler: r.sampler
                        }, l => {
                ...
                e.loadVideo(r, {
                    ...
                    e.videos.at(-1).loop = t.hasOwnProperty("loop") ? t.loop : !0, e.videos.at(-1).playbackRate = t.playbackRate || 1, e.videos.at(-1).play(), e.userData.textureLoaded = !0
                })
            }
        }
        handleEffectPlane(e, t, s) {
            ...
            let r = this.getRenderTargets()[t - 1],
                a = (o = this.curtain) == null ? void 0 : o.planes.find(l => l.type === "PingPongPlane" && l.userData.id === e.local.id),
                h = e.compiledFragmentShaders[s.passIndex ? ? 0];
            if (a && h != null && h.includes("uPingPongTexture") && U(i, "uPingPongTexture", a.getTexture()), r ? U(i, "uTexture", r.getTexture()) : U(i, "uTexture"), h != null && h.includes("uBgTexture")) {
                let l = this.getRenderTargets()[t - (1 + s.passIndex)];
                l && U(i, "uBgTexture", l.getTexture())
            }
        ...
        handleElementPlane(e, t) {
            ...
            let a = this.getRenderTargets()[t - 1],
                h = r[r.indexOf(e) - 2],
                o;
            if (e.mask && h && (o = h.local.lastTarget), i.length || (s.textures.length = 0), a && i.length ? U(s, "uTexture", a.getTexture()) : s && s.addTexture(e.preloadedCanvasTexture), a) {
                if (i.length) {
                    let l = i.reduce((d, c) => d + c.getPlanes().length, 0);
                    a = this.getRenderTargets()[t - (1 + l)]
                }
                a && (U(s, "uBgTexture", a.getTexture()), o && e.mask && U(s, "uPreviousLayerTexture", o.getTexture()))
            }
        }
        handleChildEffectPlane(e, t, s) {
            ...
            const r = e.getParent();
            let a = this.getRenderTargets()[t - 1],
                h = (f = this.curtain) == null ? void 0 : f.planes.find(p => p.type === "PingPongPlane" && p.userData.id === e.local.id),
            ...
            if (a && (d || s.passIndex > 0) ? (e.isMask && (!s.length || c && u) && i.addTexture(r.preloadedCanvasTexture), U(i, "uTexture", a.getTexture())) : e.isMask ? (c && u && i.addTexture(r.preloadedCanvasTexture), a ? U(i, "uTexture", a.getTexture()) : U(i, "uTexture")) : o != null && o.includes("uTexture") && (i.addTexture(r.preloadedCanvasTexture), r.preloadedCanvasTexture.userData.used = !0), h && o != null && o.includes("uPingPongTexture") && U(i, "uPingPongTexture", h.getTexture()), o != null && o.includes("uBgTexture"))
                if (d && s.length > 1) {
                    let p = this.getRenderTargets()[t - (1 + s.length)];
                    p && U(i, "uBgTexture", p.getTexture())
                } else r.preloadedCanvasTexture.userData.used ? i.loadCanvas(r.local.canvas, {
                    sampler: "uBgTexture",
                    premultiplyAlpha: !0
                }, p => {
            ...
            e.type === "custom" && U(i, "uCustomTexture", this.getRenderTargets()[t]), this.handleMediaTextures(i, e, s)
        }
        createPlanes() {
        ...
        createEffectPlanes(e, t) {
            ...
            }), e.usesPingPong && this.createPingPongPlane(e, t, s.passes)) : (this.createEffectPlane(e, t), e.usesPingPong && this.createPingPongPlane(e, t))
        }
        createTextures() {
        ...
        assignRenderTargetToPlane(e, t, s, i) {
            let r = this.getTextureParams(e, t, s),
                a = this.getRenderTargets()[t] || new Ce(this.curtain, r);
        ...
        setInitialEffectPlaneUniforms(e, t, s, i) {
            ...
            if (!e.userData.initialUniformsSet || !e.userData.isReady) {
                for (let a in e.uniforms)(r = t.states) != null && r.scroll.some(h => h.prop === a) || (t.local.bpProps && a in t.local.bpProps ? Ee(t.local.bpProps[a], e.uniforms[a], a) : a in t && Ee(t[a], e.uniforms[a], a));
        ...
        setInitialElementPlaneUniforms(e, t) {
            ...
            for (let i in e.uniforms) t.local.bpProps && i in t.local.bpProps ? e.uniforms[i].value = t.local.bpProps[i] : i in t && (e.uniforms[i].value = ((s = t.local.stateEffectProps) == null ? void 0 : s[i]) ? ? t[i]);
        ...
        setElementPlaneUniforms(e, t) {
            if (e.uniforms.mousePos) {
                ...
                if (!s) return;
                this.mouse.movedInView && (e.uniforms.mousePos.value.x !== s.x || e.uniforms.mousePos.value.y !== s.y) && (e.uniforms.mousePos.value.x = s.x, e.uniforms.mousePos.value.y = s.y)
            }
        }
        calculateItemMouseValues(e) {
            ...
            return this.local.mouseValuePool || (this.local.mouseValuePool = new k(.5)), this.local.mouseValuePool.x = i.x, this.local.mouseValuePool.y = i.y, this.local.mouseValuePool
        }
        getMousePosWithMomentum(e, t, s) {
            ...
            if (!e.local.lastMousePos) return e.local.lastMousePos = {
                x: h ? d : .5,
                y: o ? c : .5
            }, e.local.lastMousePos;
            const u = e.local.lastMousePos.x * t,
                f = (1 - e.local.lastMousePos.y) * s,
                p = Math.abs(i - u),
                m = Math.abs(r - f);
            return p < pe && m < pe || (h ? (i = we(i, u, l * 2), e.local.lastMousePos.x = i / t) : e.local.lastMousePos.x = .5, o ? (r = we(r, f, l * 2), e.local.lastMousePos.y = 1 - r / s) : e.local.lastMousePos.y = .5), e.local.lastMousePos
        }
        setEffectPlaneUniforms(e, t) {
            var r, a, h, o;
            let s = ((r = t.local.stateEffectProps) == null ? void 0 : r.speed) ? ? t.speed ? ? 1;
            if (t.animating && e.uniforms.time && (e.uniforms.time.value += s * 60 / this.fps), (a = t.local.stateEffectProps) != null && a.playbackRate && e.videos.at(-1) && (e.videos.at(-1).playbackRate = t.local.stateEffectProps.playbackRate), ve() && ((o = (h = this.interactivity) == null ? void 0 : h.mouse) != null && o.disableMobile)) return !1;
            if (!this.mouse.movedInView) return;
            t.local.currentFrameMouseValues || (t.local.currentFrameMouseValues = this.calculateItemMouseValues(t));
            const i = t.local.currentFrameMouseValues;
            i && (e.uniforms.previousMousePos && (this.mouse.ticks > 16 ? (e.uniforms.previousMousePos.value.x = e.uniforms.mousePos.value.x, e.uniforms.previousMousePos.value.y = e.uniforms.mousePos.value.y) : (e.uniforms.previousMousePos.value.x = i.x, e.uniforms.previousMousePos.value.y = i.y)), e.uniforms.mousePos && !i.equals(e.uniforms.mousePos.value) && (e.uniforms.mousePos.value.x = i.x, e.uniforms.mousePos.value.y = i.y), this.mouse.ticks++)
        }
        getOrderedItems() {
            let e = [];
        ...
        getTextureParams(e, t, s) {
            ...
            const i = e[t];
            let r = 1;
            return i.userData.downSample && (r = typeof i.userData.downSample == "number" ? i.userData.downSample : .5), {
        ...
        handlePlaneCreation() {
            this.initialized = !0, this.initializing = !1, this.rendering || this.renderNFrames(2), this.waitForAssetsAndDisablePlanes(), Te()
        }
        waitForAssetsAndDisablePlanes() {
            this.layers.some(t => (t.layerType === "image" || t.layerType === "text") && !t.local.loaded || Object.values(this.local.preloadedTextures).some(s => s && s.texture === null)) ? setTimeout(() => this.waitForAssetsAndDisablePlanes(), 64) : (this.layers.filter(t => t.preloadedCanvasTexture).forEach(t => {
    ...
    function Qt() {
        se(window, "scroll", Qe), ve() ? se(window, "touchmove", Se) : se(window, "mousemove", Se), se(window, "routeChange", Xe), se(document, "mouseleave", Ze), le = It(Xt, 16), ve() ? se(window, "orientationchange", le) : se(window, "resize", le), se(document, ue, $e), ke = !0
    }

    function De() {
        ie(window, "mousemove", Se), ie(window, "touchmove", Se), ie(window, "scroll", Qe), ie(window, "routeChange", Xe), ie(document, "mouseleave", Ze), le && (ie(window, "resize", le), ie(window, "orientationchange", le)), ie(document, ue, $e), ke = !1
    }

    function Zt(n, e, t) {
        return {
            canvasWidth: n.offsetWidth,
    ...
    function Kt(n, e, t, s, i) {
        ...
        if (t) {
            ...
            if (a) try {
                ...
                return h != null && h.options && (h != null && h.history) ? Promise.resolve(h) : (s(new Error(`Did not find valid JSON inside ${t}`)), Promise.reject())
            } catch (h) {
    ...
    function Je(n) {
        ...
        return new Promise((s, i) => {
            Kt(e, t, n.filePath, i, n.production).then(r => {
                ...
                const c = zt(r.history, o, Zt(h, l, d)),
                    u = new $t({
                        id: o,
                        fps: n.fps || a.fps || 60,
                        dpi: d,
                ...
                u.curtain.canvas.innerText = n.altText || "", u.curtain.canvas.setAttribute("aria-label", n.ariaLabel || "Unicorn Studio Scene"), u.curtain.canvas.setAttribute("role", "img");
                let f = a[ge("ZnJlZVBsYW4=")];
                (f || a[ge("aW5jbHVkZUxvZ28=")]) && Lt(o, h), f && console.log(ge("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")), S.push(u), u.layers = c, u.preloadTextures(), u.setInteractiveParams(n, a), u.isInView = u.isFixed || qe(u.element, u.bbox, 50), (!u.lazyLoad || u.isInView) && u.initializePlanes(), ke || Qt(), s(u)
            }).catch(r => {
                console.error(r), i(r)
            })
        })
    ...
    function ts() {
        return es() ? new Promise((n, e) => {
            const t = [...document.querySelectorAll("[data-us-project], [data-us-project-src]")],
                s = typeof window < "u" && window.requestIdleCallback ? window.requestIdleCallback : i => setTimeout(i, 0);
            t.filter(i => !i.getAttribute("data-us-initialized")).forEach((i, r) => {
                i.setAttribute("data-us-initialized", !0), s(() => {
                    const a = Y(i, "data-us-project"),
                        h = Y(i, "data-us-project-src"),
                        o = Y(i, "data-us-disablemobile"),
                        l = Y(i, "data-us-disablemouse");
                    Je({
                        projectId: h ? null : a,
                        filePath: h,
                        element: i,
                        dpi: +Y(i, "data-us-dpi"),
                        scale: +Y(i, "data-us-scale"),
                        production: Y(i, "data-us-production"),
                        fps: +Y(i, "data-us-fps"),
                        lazyLoad: Y(i, "data-us-lazyload"),
                        altText: Y(i, "data-us-alttext"),
                        ariaLabel: Y(i, "data-us-arialabel"),
                        fixed: Y(i, "data-us-fixed"),
                        interactivity: o || l ? {
                            mouse: {
                                disableMobile: o,
                                disabled: l
    ...
    I.addScene = Je, I.destroy = Jt, I.init = ts, I.scenes = S, I.unbindEvents = De, Object.defineProperty(I, Symbol.toStringTag, {
        value: "Module"
    })
});